...
1. **Check `CODEX.md`** for the test command (look for `{{TEST_COMMAND}}`)
...
Tell the user:
> "No test command found in CODEX.md. Please add your test command (e.g., `npm test`, `pytest`, `go test ./...`) to the Key Commands section."
